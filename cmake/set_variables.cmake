function(set_variables)
    ...
    if (NOT DEFINED TEST_BASE_CMAKE_SRC_DIR
        OR("${EMPTY}${TEST_BASE_CMAKE_SRC_DIR}" STREQUAL "${EMPTY}"))

        get_filename_component(l_base_cmake_src_dir "${CMAKE_SOURCE_DIR}" ABSOLUTE)
        set(TEST_BASE_CMAKE_SRC_DIR ${l_base_cmake_src_dir} 
    ...
    if (NOT DEFINED ${TEST_PREFIX}TEST_INCLUDE_DIR
        ...
        if (NOT "${EMPTY}${include_dir}" STREQUAL "${EMPTY}")
            ...
            get_filename_component(l_test_include_dir ${TEST_BASE_CMAKE_SRC_DIR}/../include ABSOLUTE)
        endif()
    else()
    ...
    if (NOT DEFINED ${TEST_PREFIX}TEST_SRC_DIR
        ...
        if (NOT "${EMPTY}${src_dir}" STREQUAL "${EMPTY}")
            ...
            get_filename_component(l_test_src_dir ${TEST_BASE_CMAKE_SRC_DIR}/../src ABSOLUTE)
        endif()
    else()
    ...
    if (NOT DEFINED ${TEST_PREFIX}TEST_TEST_SRC_DIR 
        ...
        if (NOT "${EMPTY}${test_src_dir}" STREQUAL "${EMPTY}")
            ...
            get_filename_component(l_test_test_src_dir ${TEST_BASE_CMAKE_SRC_DIR}/../test ABSOLUTE)
        endif()
    else()
    ...
    if (NOT DEFINED ${TEST_PREFIX}TEST_EXTERNAL_DIR
        ...
        if (NOT "${EMPTY}${external_dir}" STREQUAL "${EMPTY}")
            ...
            get_filename_component(l_test_external_dir ${TEST_BASE_CMAKE_SRC_DIR}/../external ABSOLUTE)
        endif()
    else()
    ...
    if (${TEST_PREFIX}TEST_USING_BUILD_UTILS)
        ...
        if (NOT DEFINED ${TEST_PREFIX}TEST_BUILD_UTILS_VERSION)
            if (NOT "${EMPTY}${build_utils_version}" STREQUAL "${EMPTY}")
                ...
                if (EXISTS ${TEST_BASE_CMAKE_SRC_DIR}/build_utils_VERSION.cmake)
                    include(${TEST_BASE_CMAKE_SRC_DIR}/build_utils_VERSION.cmake)
                    set(${TEST_PREFIX}TEST_BUILD_UTILS_VERSION ${build_utils_VERSION} 
                        CACHE STRING "build utils version" FORCE)
