#include "test/msg/fmt/param/specifier/print/Character.h"
#include "test/msg/fmt/param/specifier/val/Character.h"
...
int main()
{
    ...
    test::msg::fmt::param::Width<char> wd1{4};
    test::msg::fmt::param::Width<char> wd2{-4};
    test::msg::fmt::param::specifier::val::Character val1{.char_value = 'Z'};
    test::msg::fmt::param::specifier::val::Character val2{.wchar_value = 'K'};

    constexpr int char_format = 
        test::msg::fmt::param::flag::Character::char_format;
    constexpr int w_char_format = 
        test::msg::fmt::param::flag::Character::w_char_format;
    constexpr int wchar_format = 
        test::msg::fmt::param::flag::Character::wchar_format;
    constexpr int w_wchar_format = 
        test::msg::fmt::param::flag::Character::w_wchar_format;
