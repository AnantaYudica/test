...
int main()
{
    ...
    {
        Parameter<char, Nothing<char>> p1{};
        ...
        Parameter<char, Nothing<char>> p2{p1};
        ...
        Parameter<char, Nothing<char>> p3{std::move(p2)};
        ...
        Parameter<char, Nothing<char>> p4;
        ...
        Parameter<char, Nothing<char>> p5;
    ...
    {
        Parameter<char, Nothing<char>> p1{Nothing<char>{}};
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == false);
        assert(pp1->IsSet() == false);
    ...
    {
        Parameter<char, Nothing<char>> p1{Nothing<char>{1234}};
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == true);
        assert(pp1->IsSet() == true);
    ...
    {
        Parameter<char, Nothing<char>, Nothing<char>> p1{};
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == false);
        assert(pp1->IsSet() == false);
        ...
        Parameter<char, Nothing<char>, Nothing<char>> p2{p1};
        Parameter<char> * pp2 = &p2;
        assert(p2.IsSet() == true);
        assert(pp2->IsSet() == true);
        ...
        Parameter<char, Nothing<char>, Nothing<char>> p3{std::move(p2)};
        Parameter<char> * pp3 = &p3;
        assert(p3.IsSet() == true);
        assert(pp3->IsSet() == true);
        assert(p2.IsSet() == false);
        ...
        Parameter<char, Nothing<char>, Nothing<char>> p4;
        Parameter<char> * pp4 = &p4;
        p4 = p3;
        ...
        Parameter<char, Nothing<char>, Nothing<char>> p5;
        Parameter<char> * pp5 = &p5;
        p5 = std::move(p4);
        assert(p5.IsSet() == true);
        assert(pp5->IsSet() == true);
    ...
    {
        Parameter<char, Nothing<char>, Nothing<char>> p1{
            Nothing<char>{1234}, Nothing<char>{}
        };
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == false);
        assert(pp1->IsSet() == false);
    ...
    {
        Parameter<char, Nothing<char>, Nothing<char>> p1{
            Nothing<char>{}, Nothing<char>{1234}
        };
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == false);
        assert(pp1->IsSet() == false);
    ...
    {
        Parameter<char, Nothing<char>, Nothing<char>> p1{
            Nothing<char>{1234}, Nothing<char>{1234}
        };
        Parameter<char> * pp1 = &p1;
        assert(p1.IsSet() == true);
        assert(pp1->IsSet() == true);
