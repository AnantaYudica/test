...
int main()
{
    test::msg::Argument<test::msg::arg::type::val::Sequence<0>> arg_seq0;
    test::msg::Argument<test::msg::arg::type::val::Sequence<1>> arg_seq1;

    test::Variable<test::type::val::Sequence<int, -1>,
        test::type::val::Sequence<int, 4, 9>> var1;
    ...
    assert(arg_seq0.Get<0>(test::type::Index<CaseA1, 0>{}, var1) == -1);

    res_a = out_cstr1.Print("%d%d", 4, 9);
    ...
    assert(arg_seq1.Get<0>(test::type::Index<CaseA1, 0>{}, var1) == 4);
    assert(arg_seq1.Get<1>(test::type::Index<CaseA1, 0>{}, var1) == 9);
