...
int main()
{
    test::msg::Argument<test::msg::arg::type::val::seq::At<0, 3>> arg_seq0;
    test::msg::Argument<test::msg::arg::type::val::seq::At<2, 0>,
        test::msg::arg::type::val::seq::At<0, 1>> arg_seq1;
    
    test::Variable<test::type::val::Sequence<int, -1, 2, 40, -2>, int,
