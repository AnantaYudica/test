...
int main()
{
    test::msg::Argument<test::msg::arg::type::param::name::At<0, 0>> arg_name0;
    test::msg::Argument<test::msg::arg::type::param::name::At<2, 2>,
        test::msg::arg::type::param::name::At<0, 3>> arg_name1;
    ...
    auto res_a = out_cstr1.Print("char");
    ...
    res_a = out_cstr1.Print("%s%s", "long long", "int");
