...
int main()
{
    ...
    auto res_a = out_cstr1.Print("char, float, long double, int");
    ...
    assert(strcmp(*(arg_name0.Get(test::type::Index<CaseA1, 0>{}, var1)), 
        "char, float, long double, int")== 0);

    res_a = out_cstr1.Print("%s%s", "unsigned char, signed char, long long",
        "char, float, long double, int");
    ...
    assert(strcmp(*(arg_name1.Get(test::type::Index<CaseA1, 0>{}, var1)), 
        "unsigned char, signed char, long long")== 0);
