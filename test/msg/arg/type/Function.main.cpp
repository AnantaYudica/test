...
int main()
{
    test::msg::Argument<test::msg::arg::type::Function<0>> arg_func0;
    test::msg::Argument<test::msg::arg::type::Function<0>,
        test::msg::arg::type::Function<1>> arg_func1;
    test::msg::Argument<test::msg::arg::type::Function<0,
        test::msg::arg::Value<1>>> arg_func2;
    test::msg::Argument<test::msg::arg::type::Function<0,
        test::msg::arg::Value<2>>, test::msg::arg::type::Function<1,
        test::msg::arg::Value<3>>> arg_func3;
    
    test::Variable<test::type::Function<decltype(CallFunc1), &CallFunc1>> var1;
    test::Variable<test::type::Function<decltype(CallFunc2), &CallFunc2>,
        test::type::Function<decltype(CallFunc1), &CallFunc1>> var2;
    test::Variable<test::type::Function<decltype(CallFunc3), &CallFunc3>,
        test::Value<int>> var3{40};
    test::Variable<test::type::Function<decltype(CallFunc4), &CallFunc4>,
        test::type::Function<decltype(CallFunc3), &CallFunc3>,
        test::Value<double>, test::Value<int>> var4{6.28, 40};
