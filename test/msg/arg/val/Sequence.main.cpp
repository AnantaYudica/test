...
int main()
{
    test::msg::Argument<test::msg::arg::val::Sequence<0>> arg_seq0;
    test::msg::Argument<test::msg::arg::val::Sequence<1>> arg_seq1;

    test::Variable<test::val::Sequence<int, 1>,
        test::val::Sequence<int, 2>> var1{-1, 4, 9};
