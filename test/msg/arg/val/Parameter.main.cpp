...
int main()
{
    test::msg::Argument<test::msg::arg::val::Parameter<0>> arg_param0;
    test::msg::Argument<test::msg::arg::val::Parameter<2>> arg_param1;

    test::Variable<test::val::Parameter<int>, int,
        test::val::Parameter<double, int>> var1{22, 3.14, -30};
    ...
    assert(arg_param0.Get<0>(test::type::Index<CaseA1, 0>{}, var1) == 22);
    ...
    assert(arg_param1.Get<0>(test::type::Index<CaseA1, 0>{}, var1) == 3.14);
    assert(arg_param1.Get<1>(test::type::Index<CaseA1, 0>{}, var1) == -30);
