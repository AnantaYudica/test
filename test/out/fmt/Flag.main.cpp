...
{
    {
        ...
        assert(fl1.IsRequireValueInput() == false);
        assert(fl1.IsRequireWidthInput() == false);
        assert(fl1.IsRequireLengthInput() == false);
        assert(fl1.IsRequirePrecisionInput() == false);
    }
    {
    ...
    }
    {
        ...
        assert(fl1.IsRequireValueInput() == true);
        assert(fl1.IsRequireWidthInput() == false);
        assert(fl1.IsRequireLengthInput() == false);
        assert(fl1.IsRequirePrecisionInput() == false);
    }
    ...
    }
    {
        ...
        assert(fl1.IsRequireValueInput() == false);
        assert(fl1.IsRequireWidthInput() == true);
        assert(fl1.IsRequireLengthInput() == true);
        assert(fl1.IsRequirePrecisionInput() == true);
    }
    return 0;
}
