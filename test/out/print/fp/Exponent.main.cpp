...
{
    {
        ...
        auto cstr1 = test::out::print::fp::Exponent(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::Exponent(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::Exponent(fp1.GetBase<10, false>(), 10);
        assert(cstr3.Size() == 0);
    }
    {
    ...
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent(fp1.GetBase<10, true>());
        assert(cstr1.Size() == 3);
        assert(strcmp(*cstr1, "e+0") == 0);

        auto cstr2 = test::out::print::fp::Exponent(fp1.GetBase<10, true>(), 1);
        assert(cstr2.Size() == 3);
        assert(strcmp(*cstr2, "e+0") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent(fp1.GetBase<10, true>(), 10);
    ...
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent(fp1.GetBase<2, true>());
        assert(cstr1.Size() == 3);
        assert(strcmp(*cstr1, "p+1") == 0);

        auto cstr2 = test::out::print::fp::Exponent(fp1.GetBase<2, true>(), 1);
        assert(cstr2.Size() == 3);
        assert(strcmp(*cstr2, "p+1") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent(fp1.GetBase<2, true>(), 10);
        assert(cstr3.Size() == 10);
    ...
    }
    {
        ...
        auto cstr2 = test::out::print::fp::Exponent(fp1.GetBase<2, true>(), 3);
        assert(cstr2.Size() == 4);
    ...
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            false>(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            false>(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
    ...
    ///
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, false>(), 10);
        assert(cstr3.Size() == 0);
    }
    {
        test::FloatingPoint<double> fp1{3.14};
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, true>());
        assert(cstr1.Size() == 1);
        assert(strcmp(*cstr1, "0") == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, true>(), 2);
        assert(cstr2.Size() == 2);
        assert(strcmp(*cstr2, "00") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, true>(), 10);
        assert(cstr3.Size() == 10);
    ...
    }
    {
        ...
        auto cstr2 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<10, true>(), 1);
        assert(cstr2.Size() == 2);
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<2, true>());
        assert(cstr1.Size() == 1);
        assert(strcmp(*cstr1, "1") == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<2, true>(), 1);
        assert(cstr2.Size() == 1);
        assert(strcmp(*cstr2, "1") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<2, true>(), 10);
        assert(cstr3.Size() == 10);
    ...
    }
    {
        ...
        auto cstr2 = test::out::print::fp::Exponent<char, 
            true, false>(fp1.GetBase<2, true>(), 3);
        assert(cstr2.Size() == 3);
    ...
    ///
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, false>(), 10);
        assert(cstr3.Size() == 0);
    }
    {
        test::FloatingPoint<double> fp1{3.14};
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, true>());
        assert(cstr1.Size() == 1);
        assert(strcmp(*cstr1, "0") == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, true>(), 1);
        assert(cstr2.Size() == 1);
        assert(strcmp(*cstr2, "0") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<10, true>(), 10);
        assert(cstr3.Size() == 10);
        assert(strcmp(*cstr3, "0000000000") == 0);
    }
    {
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<2, true>());
        assert(cstr1.Size() == 1);
        assert(strcmp(*cstr1, "1") == 0);

        auto cstr2 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<2, true>(), 1);
        assert(cstr2.Size() == 1);
        assert(strcmp(*cstr2, "1") == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<2, true>(), 10);
        assert(cstr3.Size() == 10);
        assert(strcmp(*cstr3, "0000000001") == 0);
    }
    {
        ...
        auto cstr2 = test::out::print::fp::Exponent<char, 
            false, false>(fp1.GetBase<2, true>(), 3);
        assert(cstr2.Size() == 3);
        assert(strcmp(*cstr2, "041") == 0);
    ...
    //// WCHAR
    {
        ...
        auto cstr1 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, false>(), 10);
        assert(cstr3.Size() == 0);
    }
    {
        test::FloatingPoint<double> fp1{3.14};
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, true>());
        assert(cstr1.Size() == 3);
        assert(wcscmp(*cstr1, L"e+0") == 0);

        auto cstr2 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, true>(), 1);
        assert(cstr2.Size() == 3);
        assert(wcscmp(*cstr2, L"e+0") == 0);
        
        auto cstr3 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<10, true>(), 10);
        assert(cstr3.Size() == 10);
    ...
    }
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<2, true>());
        assert(cstr1.Size() == 3);
        assert(wcscmp(*cstr1, L"p+1") == 0);

        auto cstr2 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<2, true>(), 1);
        assert(cstr2.Size() == 3);
        assert(wcscmp(*cstr2, L"p+1") == 0);
        
        auto cstr3 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<2, true>(), 10);
        assert(cstr3.Size() == 10);
    ...
    }
    {
        ...
        auto cstr2 = test::out::print::fp::
            Exponent<wchar_t>(fp1.GetBase<2, true>(), 3);
        assert(cstr2.Size() == 4);
    ...
    {
        test::FloatingPoint<float> fp1{3.14f};
        auto cstr1 = test::out::print::fp::Exponent<wchar_t, 
            false>(fp1.GetBase<10, false>());
        assert(cstr1.Size() == 0);

        auto cstr2 = test::out::print::fp::Exponent<wchar_t, 
            false>(fp1.GetBase<10, false>(), 1);
        assert(cstr2.Size() == 0);
        
        auto cstr3 = test::out::print::fp::Exponent<wchar_t, 
            false>(fp1.GetBase<10, false>(), 10);
        assert(cstr3.Size() == 0);
    }
    {
