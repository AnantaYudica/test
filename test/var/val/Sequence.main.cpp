...
int main()
{
    ...
    test::Variable<ValSeq4> var1(1, 2, 3, 4);
    ...
    test::Variable<int, test::val::Sequence<int, 2>> var2(6, 11);
    auto& var2_at_1 = dynamic_cast<test::Variable<
        test::val::Sequence<int, 2>>&>(var2);
    std::cout << "var2_at_1 at 0 : " << var2_at_1.Get().At<0>() << std::endl;
    std::cout << "var2_at_1 at 1 : " << var2_at_1.Get().At<1>() << std::endl;

    test::Variable<test::val::Sequence<int, 2>, int,
        test::val::Sequence<int, 1>, char> var3(4, 6, 10);
    std::cout << "var3_at_0 at 0 : " << var3.Get().At<0>() << std::endl;
    std::cout << "var3_at_0 at 1 : " << var3.Get().At<1>() << std::endl;
    
    auto& var3_at_2 = dynamic_cast<test::Variable<
        test::val::Sequence<int, 1>, char>&>(var3);
