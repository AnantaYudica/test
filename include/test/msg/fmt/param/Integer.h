#ifndef TEST_MSG_FMT_PARAM_INTEGER_H_
#define TEST_MSG_FMT_PARAM_INTEGER_H_

#include "../Parameter.h"
#include "../var/Integer.h"
...
class Parameter<TChar, test::msg::fmt::var::Integer<TChar>> :
...
public:
    ...
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Integer<TChar>&& int_var);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, 
        test::msg::fmt::var::Integer<TChar>>& cpy);
    Parameter(Parameter<TChar, 
        test::msg::fmt::var::Integer<TChar>>&& mov);
public:
...
class Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...> :
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<
            ...
            !std::is_base_of<test::msg::fmt::var::Integer<TChar>,
                _TArg>::value &&
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<!std::is_same<_TArg, 
            test::msg::fmt::var::Integer<TChar>>::value, int>::type = 0>
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args);
    template<typename... TArgs>
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Integer<TChar>&& int_var, TArgs&&... args);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, test::msg::fmt::var::Integer<TChar>,
        TParam...>& cpy);
    Parameter(Parameter<TChar, test::msg::fmt::var::Integer<TChar>, 
        TParam...>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>& 
        operator=(const Parameter<TChar, 
            test::msg::fmt::var::Integer<TChar>, TParam...>& cpy);
    Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>& 
        operator=(Parameter<TChar, test::msg::fmt::var::Integer<TChar>, 
            TParam...>&& mov);
public:
    virtual std::size_t VLoad(std::size_t size, std::size_t index, 
        va_list& args) override;
...
Parameter<TChar, test::msg::fmt::var::Integer<TChar>>& 
    Parameter<TChar, test::msg::fmt::var::Integer<TChar>>::
        operator=(Parameter<TChar, test::msg::fmt::var::Integer<TChar>>&& mov)
{
...
template<typename TChar>
std::size_t Parameter<TChar, test::msg::fmt::var::Integer<TChar>>::
...
template<typename TChar>
typename Parameter<TChar, test::msg::fmt::var::Integer<TChar>>::
...
template<typename TChar>
void Parameter<TChar, test::msg::fmt::var::Integer<TChar>>::Unset()
{
    m_value.Unset();
}

template<typename TChar>
bool Parameter<TChar, test::msg::fmt::var::Integer<TChar>>::IsSet() const
{
...
template<typename TArg, typename... TArgs, typename _TArg,
    typename std::enable_if<!std::is_same<_TArg, 
        test::msg::fmt::var::Integer<TChar>>::value, int>::type>
Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>::
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args) :
        Parameter<TChar, TParam...>(std::forward<StatusPointerType>(status),
...
Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>& 
Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>::
    operator=(const Parameter<TChar, test::msg::fmt::var::Integer<TChar>,
        TParam...>& cpy)
{
...
template<typename TChar, typename... TParam>
void Parameter<TChar, test::msg::fmt::var::Integer<TChar>, 
    TParam...>::Unset()
{
    m_value.Unset();
...
template<typename TChar, typename... TParam>
bool Parameter<TChar, test::msg::fmt::var::Integer<TChar>, TParam...>::
    IsSet() const
{
...
#endif //!TEST_MSG_FMT_PARAM_INTEGER_H_
