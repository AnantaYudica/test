...
public:   
    ...
    static constexpr ValueType uhu_unsigned_long_long_format = 
        ...
        upper;
public:
    static constexpr ValueType p__lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | prefix;
    static constexpr ValueType p__lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | prefix;
public:
    static constexpr ValueType p__ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | prefix;
    static constexpr ValueType p__ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        prefix;
    static constexpr ValueType p__ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | prefix;
public:
...
public:
    ...
    static constexpr ValueType pp__lds_unsigned_long_long_format =
        ...
        lower | prefix | plus;
public:
    static constexpr ValueType pp__ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | prefix | plus;
public:
    static constexpr ValueType pp__lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | prefix | plus;
public:  
    static constexpr ValueType pp__lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        prefix | plus;
    static constexpr ValueType pp__lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
    static constexpr ValueType pp__lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | prefix | plus;
public:   
    static constexpr ValueType pp__uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        prefix | plus;
    static constexpr ValueType pp__uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        prefix | plus;
    static constexpr ValueType pp__uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        prefix | plus;
    static constexpr ValueType pp__uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
    static constexpr ValueType pp__uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | prefix | plus;
public:
    ...
    static constexpr ValueType ps__lds_unsigned_long_long_format =
        ...
        lower | prefix | space;
public:
    static constexpr ValueType ps__ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | prefix | space;
    static constexpr ValueType ps__ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        prefix | space;
    static constexpr ValueType ps__ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | prefix | space;
public:
    static constexpr ValueType ps__lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        prefix | space;
    static constexpr ValueType ps__lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | prefix | space;
public:  
    static constexpr ValueType ps__lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        prefix | space;
    static constexpr ValueType ps__lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        prefix | space;
    static constexpr ValueType ps__lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        prefix | space;
    static constexpr ValueType ps__lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | prefix | space;
    static constexpr ValueType ps__lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | prefix | space;
public:   
    static constexpr ValueType ps__uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        prefix | space;
    static constexpr ValueType ps__uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        prefix | space;
    static constexpr ValueType ps__uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        prefix | space;
    static constexpr ValueType ps__uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | prefix | space;
    static constexpr ValueType ps__uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | prefix | space; 
public:
...
public:   
    ...
    static constexpr ValueType w_uhu_unsigned_long_long_format = 
        ...
        upper | width;
public:
    static constexpr ValueType p_w_lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | width | prefix;
public:
    static constexpr ValueType p_w_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix;
    static constexpr ValueType p_w_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | prefix;
    static constexpr ValueType p_w_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix;
public:
...
public:
    static constexpr ValueType pp_w_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix | plus;
public:
    static constexpr ValueType pp_w_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | width | prefix | plus;
public:  
    static constexpr ValueType pp_w_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        width | prefix | plus;
    static constexpr ValueType pp_w_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
    static constexpr ValueType pp_w_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | plus;
public:   
    static constexpr ValueType pp_w_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        width | prefix | plus;
    static constexpr ValueType pp_w_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        width | prefix | plus;
    static constexpr ValueType pp_w_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        width | prefix | plus;
    static constexpr ValueType pp_w_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
    static constexpr ValueType pp_w_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | plus;
public:
...
public:
    static constexpr ValueType ps_w_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | prefix | space;
public:
    static constexpr ValueType ps_w_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | width | prefix | space;
public:  
    static constexpr ValueType ps_w_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        width | prefix | space;
    static constexpr ValueType ps_w_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
    static constexpr ValueType ps_w_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | prefix | space;
public:   
    static constexpr ValueType ps_w_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        width | prefix | space;
    static constexpr ValueType ps_w_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        width | prefix | space;
    static constexpr ValueType ps_w_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        width | prefix | space;
    static constexpr ValueType ps_w_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | space;
    static constexpr ValueType ps_w_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | prefix | space; 
public:
...
public:   
    ...
    static constexpr ValueType l_uhu_unsigned_long_long_format = 
        ...
        upper | length;
public:
    static constexpr ValueType p_l_lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | length | prefix;
public:
    static constexpr ValueType p_l_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix;
    static constexpr ValueType p_l_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        length | prefix;
    static constexpr ValueType p_l_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix;
public:
...
public:
    static constexpr ValueType pp_l_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | plus;
public:
    static constexpr ValueType pp_l_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | length | prefix | plus;
public:  
    static constexpr ValueType pp_l_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        length | prefix | plus;
    static constexpr ValueType pp_l_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
    static constexpr ValueType pp_l_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | plus;
public:   
    static constexpr ValueType pp_l_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        length | prefix | plus;
    static constexpr ValueType pp_l_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        length | prefix | plus;
    static constexpr ValueType pp_l_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        length | prefix | plus;
    static constexpr ValueType pp_l_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
    static constexpr ValueType pp_l_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | plus;
public:
...
public:
    static constexpr ValueType ps_l_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | space;
public:
    static constexpr ValueType ps_l_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | length | prefix | space;
public:  
    static constexpr ValueType ps_l_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        length | prefix | space;
    static constexpr ValueType ps_l_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
    static constexpr ValueType ps_l_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | space;
public:   
    static constexpr ValueType ps_l_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        length | prefix | space;
    static constexpr ValueType ps_l_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        length | prefix | space;
    static constexpr ValueType ps_l_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        length | prefix | space;
    static constexpr ValueType ps_l_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | space;
    static constexpr ValueType ps_l_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | space; 
public:
    static constexpr ValueType pz_l_lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | length | prefix | zero;
public:
    static constexpr ValueType pz_l_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | length | prefix | zero;
public:
    static constexpr ValueType pz_l_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | length | prefix | zero;
public:  
    static constexpr ValueType pz_l_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        length | prefix | zero;
    static constexpr ValueType pz_l_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
    static constexpr ValueType pz_l_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | length | prefix | zero;
public:   
    static constexpr ValueType pz_l_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        length | prefix | zero;
    static constexpr ValueType pz_l_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        length | prefix | zero;
    static constexpr ValueType pz_l_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        length | prefix | zero;
    static constexpr ValueType pz_l_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
    static constexpr ValueType pz_l_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | length | prefix | zero;
public:
...
public:   
    ...
    static constexpr ValueType wl_uhu_unsigned_long_long_format = 
        ...
        upper | width | length;
public:
    static constexpr ValueType p_wl_lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | width | length | prefix;
public:
    static constexpr ValueType p_wl_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix;
    static constexpr ValueType p_wl_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix;
    static constexpr ValueType p_wl_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix;
public:
...
public:
    static constexpr ValueType pp_wl_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | plus;
public:
    static constexpr ValueType pp_wl_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | width | length | prefix | plus;
public:  
    static constexpr ValueType pp_wl_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
    static constexpr ValueType pp_wl_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | plus;
public:   
    static constexpr ValueType pp_wl_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
    static constexpr ValueType pp_wl_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | plus;
public:
...
public:
    static constexpr ValueType ps_wl_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | space;
public:
    static constexpr ValueType ps_wl_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | width | length | prefix | space;
public:  
    static constexpr ValueType ps_wl_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
    static constexpr ValueType ps_wl_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | space;
public:   
    static constexpr ValueType ps_wl_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space;
    static constexpr ValueType ps_wl_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | space; 
public:
    static constexpr ValueType pz_wl_lds_char_format = 
        define_signed | define_char | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_short_format =
        define_signed | define_short | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_int_format = 
        define_signed | define_int | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_long_format =
        define_signed | define_long | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_long_long_format =
        define_signed |  define_long_long | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_unsigned_char_format =
        define_unsigned | define_char | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_unsigned_short_format =
        define_unsigned | define_short | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_unsigned_int_format =
        define_unsigned | define_int | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_unsigned_long_format =
        define_unsigned | define_long | signed_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lds_unsigned_long_long_format =
        define_unsigned | define_long_long | signed_integer | decimal | 
        lower | width | length | prefix | zero;
public:
    static constexpr ValueType pz_wl_ldu_char_format = 
        define_signed | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_short_format = 
        define_signed | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_int_format = 
        define_signed | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_long_format = 
        define_signed | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | decimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_ldu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | decimal | 
        lower | width | length | prefix | zero;
public:
    static constexpr ValueType pz_wl_lou_char_format = 
        define_signed | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_short_format = 
        define_signed | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_int_format = 
        define_signed | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_long_format = 
        define_signed | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_long_long_format = 
        define_signed | define_long_long | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | octal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lou_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | octal | 
        lower | width | length | prefix | zero;
public:  
    static constexpr ValueType pz_wl_lhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | lower | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
    static constexpr ValueType pz_wl_lhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        lower | width | length | prefix | zero;
public:   
    static constexpr ValueType pz_wl_uhu_char_format = 
        define_signed | define_char | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_short_format = 
        define_signed | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_int_format = 
        define_signed | define_int | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_long_format = 
        define_signed | define_long | unsigned_integer | hexadecimal | upper | 
        width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_long_long_format = 
        define_signed | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_unsigned_char_format = 
        define_unsigned | define_char | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_unsigned_short_format = 
        define_unsigned | define_short | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_unsigned_int_format = 
        define_unsigned | define_int | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_unsigned_long_format = 
        define_unsigned | define_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
    static constexpr ValueType pz_wl_uhu_unsigned_long_long_format = 
        define_unsigned | define_long_long | unsigned_integer | hexadecimal | 
        upper | width | length | prefix | zero;
public:
    static constexpr ValueType signed_not_support = 
        signed_integer | hexadecimal | octal;
    static constexpr ValueType upper_not_support = 
        upper | decimal | octal;
private:
    ValueType m_value;
public:
