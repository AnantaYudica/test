#ifndef TEST_MSG_FMT_PARAM_STRING_H_
#define TEST_MSG_FMT_PARAM_STRING_H_
...
class Parameter<TChar, test::msg::fmt::var::String<TChar>> :
...
private:
    test::msg::fmt::var::String<TChar> m_value;
public:
    Parameter();
    Parameter(const test::msg::fmt::var::String<TChar>& str_var);
    Parameter(test::msg::fmt::var::String<TChar>&& str_var);
public:
    Parameter(StatusPointerType&& status);
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::String<TChar>&& str_var);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, 
        test::msg::fmt::var::String<TChar>>& cpy);
    Parameter(Parameter<TChar, 
        test::msg::fmt::var::String<TChar>>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::String<TChar>>& 
...
class Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...> :
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<
            ...
            !std::is_base_of<test::msg::fmt::var::String<TChar>, 
                _TArg>::value &&
    ...
    Parameter(const test::msg::fmt::var::String<TChar>& str_var, 
        TArgs&&... args);
    template<typename... TArgs>
    Parameter(test::msg::fmt::var::String<TChar>&& str_var, TArgs&&... args);
public:
    Parameter(StatusPointerType&& status);
    template<typename TArg, typename... TArgs, typename _TArg = 
        typename std::remove_cv<typename std::remove_reference<TArg>::
        ...
        typename std::enable_if<!std::is_same<_TArg, 
            test::msg::fmt::var::String<TChar>>::value, int>::type = 0>
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args);
    template<typename... TArgs>
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::String<TChar>&& str_var, TArgs&&... args);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, test::msg::fmt::var::String<TChar>,
        TParam...>& cpy);
    Parameter(Parameter<TChar, test::msg::fmt::var::String<TChar>, 
        TParam...>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>& 
        operator=(const Parameter<TChar, 
            test::msg::fmt::var::String<TChar>, TParam...>& cpy);
    Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>& 
        operator=(Parameter<TChar, test::msg::fmt::var::String<TChar>, 
            TParam...>&& mov);
public:
    virtual std::size_t VLoad(std::size_t size, std::size_t index, 
        va_list& args) override;
...
template<typename TChar>
Parameter<TChar, test::msg::fmt::var::String<TChar>>::Parameter() :
    Parameter<TChar>(),
...
template<typename TChar>
std::size_t Parameter<TChar, test::msg::fmt::var::String<TChar>>::
...
template<typename TChar>
typename Parameter<TChar, test::msg::fmt::var::String<TChar>>::
...
template<typename TChar>
void Parameter<TChar, test::msg::fmt::var::String<TChar>>::Unset()
{
    m_value.Unset();
}

template<typename TChar>
bool Parameter<TChar, test::msg::fmt::var::String<TChar>>::IsSet() const
{
...
template<typename TArg, typename... TArgs, typename _TArg,
    typename std::enable_if<!std::is_same<_TArg, 
        test::msg::fmt::var::String<TChar>>::value, int>::type>
Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>::
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args) :
        Parameter<TChar, TParam...>(std::forward<StatusPointerType>(status),
...
Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>& 
Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>::
    operator=(const Parameter<TChar, test::msg::fmt::var::String<TChar>,
        TParam...>& cpy)
{
...
template<typename TChar, typename... TParam>
void Parameter<TChar, test::msg::fmt::var::String<TChar>, 
    TParam...>::Unset()
{
    m_value.Unset();
...
template<typename TChar, typename... TParam>
bool Parameter<TChar, test::msg::fmt::var::String<TChar>, TParam...>::
    IsSet() const
{
...
#endif //!TEST_MSG_FMT_PARAM_STRING_H_
