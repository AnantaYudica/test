#ifndef TEST_MSG_FMT_PARAM_POINTER_H_
#define TEST_MSG_FMT_PARAM_POINTER_H_

#include "../Parameter.h"
#include "../var/Pointer.h"
...
class Parameter<TChar, test::msg::fmt::var::Pointer<TChar>> :
...
private:
    test::msg::fmt::var::Pointer<TChar> m_value;
public:
    Parameter();
    Parameter(const test::msg::fmt::var::Pointer<TChar>& ptr_var);
    Parameter(test::msg::fmt::var::Pointer<TChar>&& ptr_var);
public:
    Parameter(StatusPointerType&& status);
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Pointer<TChar>&& ptr_var);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, 
        test::msg::fmt::var::Pointer<TChar>>& cpy);
    Parameter(Parameter<TChar, 
        test::msg::fmt::var::Pointer<TChar>>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>& 
...
class Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...> :
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<
            ...
            !std::is_base_of<test::msg::fmt::var::Pointer<TChar>, 
                _TArg>::value &&
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<!std::is_same<_TArg, 
            test::msg::fmt::var::Pointer<TChar>>::value, int>::type = 0>
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args);
    template<typename... TArgs>
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Pointer<TChar>&& ptr_var, TArgs&&... args);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, test::msg::fmt::var::Pointer<TChar>,
        TParam...>& cpy);
    Parameter(Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, 
        TParam...>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>& 
        operator=(const Parameter<TChar, 
            test::msg::fmt::var::Pointer<TChar>, TParam...>& cpy);
    Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>& 
        operator=(Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, 
            TParam...>&& mov);
public:
    virtual std::size_t VLoad(std::size_t size, std::size_t index, 
        va_list& args) override;
...
template<typename TChar>
Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>::Parameter() :
    Parameter<TChar>(),
...
template<typename TChar>
std::size_t Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>::
...
template<typename TChar>
typename Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>::
...
template<typename TChar>
void Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>::Unset()
{
    m_value.Unset();
}

template<typename TChar>
bool Parameter<TChar, test::msg::fmt::var::Pointer<TChar>>::IsSet() const
{
...
template<typename TArg, typename... TArgs, typename _TArg,
    typename std::enable_if<!std::is_same<_TArg, 
        test::msg::fmt::var::Pointer<TChar>>::value, int>::type>
Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>::
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args) :
        Parameter<TChar, TParam...>(std::forward<StatusPointerType>(status),
...
Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>& 
Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>::
    operator=(const Parameter<TChar, test::msg::fmt::var::Pointer<TChar>,
        TParam...>& cpy)
{
...
template<typename TChar, typename... TParam>
void Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, 
    TParam...>::Unset()
{
    m_value.Unset();
...
template<typename TChar, typename... TParam>
bool Parameter<TChar, test::msg::fmt::var::Pointer<TChar>, TParam...>::
    IsSet() const
{
...
#endif //!TEST_MSG_FMT_PARAM_POINTER_H_
