...
public:
    Parameter();
    Parameter(const test::msg::fmt::var::Character<TChar>& char_var);
    Parameter(test::msg::fmt::var::Character<TChar>&& char_var);
public:
    Parameter(StatusPointerType&& status);
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Character<TChar>&& char_var);
public:
    virtual ~Parameter();
public:
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<
            ...
            !std::is_base_of<test::msg::fmt::var::Character<TChar>,
                _TArg>::value &&
...
public:
    ...
    template<typename TArg, typename... TArgs, typename _TArg = 
        ...
        typename std::enable_if<!std::is_same<_TArg, 
            test::msg::fmt::var::Character<TChar>>::value, int>::type = 0>
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args);
    template<typename... TArgs>
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::Character<TChar>&& char_var, TArgs&&... args);
public:
    virtual ~Parameter();
public:
...
template<typename TArg, typename... TArgs, typename _TArg,
    typename std::enable_if<!std::is_same<_TArg, 
        test::msg::fmt::var::Character<TChar>>::value, int>::type>
Parameter<TChar, test::msg::fmt::var::Character<TChar>, TParam...>::
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args) :
        Parameter<TChar, TParam...>(std::forward<StatusPointerType>(status),
