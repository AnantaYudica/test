#ifndef TEST_MSG_FMT_PARAM_FLOATINGPOINT_H_
#define TEST_MSG_FMT_PARAM_FLOATINGPOINT_H_

#include "../Parameter.h"
#include "../var/FloatingPoint.h"
...
class Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>> :
...
public:
    ...
    Parameter(StatusPointerType&& status, 
        test::msg::fmt::var::FloatingPoint<TChar>&& fpoint_var);
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, 
        test::msg::fmt::var::FloatingPoint<TChar>>& cpy);
    Parameter(Parameter<TChar, 
        test::msg::fmt::var::FloatingPoint<TChar>>&& mov);
public:
...
class Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...> :
...
public:
    virtual ~Parameter();
public:
    Parameter(const Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>,
        TParam...>& cpy);
    Parameter(Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, 
        TParam...>&& mov);
public:
    Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>& 
        operator=(const Parameter<TChar, 
            test::msg::fmt::var::FloatingPoint<TChar>, TParam...>& cpy);
    Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>& 
        operator=(Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, 
            TParam...>&& mov);
public:
    virtual std::size_t VLoad(std::size_t size, std::size_t index, 
        va_list& args) override;
...
template<typename TChar>
std::size_t Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>>::
...
template<typename TChar>
typename Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>>::
...
template<typename TChar>
void Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>>::Unset()
{
    m_value.Unset();
}

template<typename TChar>
bool Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>>::IsSet() const
{
...
template<typename TArg, typename... TArgs, typename _TArg,
    typename std::enable_if<!std::is_same<_TArg, 
        test::msg::fmt::var::FloatingPoint<TChar>>::value, int>::type>
Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>::
    Parameter(StatusPointerType&& status, TArg&& arg, TArgs&&... args) :
        Parameter<TChar, TParam...>(std::forward<StatusPointerType>(status),
...
Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>& 
Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>::
    operator=(const Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>,
        TParam...>& cpy)
{
...
template<typename TChar, typename... TParam>
void Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, 
    TParam...>::Unset()
{
    m_value.Unset();
...
template<typename TChar, typename... TParam>
bool Parameter<TChar, test::msg::fmt::var::FloatingPoint<TChar>, TParam...>::
    IsSet() const
{
...
#endif //!TEST_MSG_FMT_PARAM_FLOATINGPOINT_H_
