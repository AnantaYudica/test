#ifndef TEST_MSG_ARG_VAL_FUNCTION_H_
#define TEST_MSG_ARG_VAL_FUNCTION_H_
...
class Argument<arg::val::Function<I, TArgArgs...>, TArgs...> :
...
public:
    template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs, 
        typename TGet = typename Argument<arg::val::Function<I, TArgArgs...>, 
...
template<std::size_t I, typename... TArgArgs, typename... TArgs>
Argument<arg::val::Function<I, TArgArgs...>, TArgs...>::Argument()
{}
...
template<typename TRet, typename TFuncMmbr, typename TDerived, 
    typename... TFuncMmbrArgs, typename TCaseId, std::size_t ICaseId, 
    typename... TVarArgs>
TRet Argument<arg::val::Function<I, TArgArgs...>, TArgs...>::
...
template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs, 
    typename TGet>
TGet Argument<arg::val::Function<I, TArgArgs...>, TArgs...>::
    Get(const test::type::Index<TCaseId, ICaseId>& i_case_id, 
        test::Variable<TVarArgs...>& var)
{
    return std::move(Argument<TArgArgs...>{}.
        template Call<GetType<test::Variable<TVarArgs...>>>(
            i_case_id, test::var::At<I>(var).Get().Get(), var));
}
