#ifndef TEST_MSG_ARG_VAL_SEQ_AT_H_
#define TEST_MSG_ARG_VAL_SEQ_AT_H_
...
class Argument<arg::val::seq::At<I, IAt>, TArgs...> :
...
public:
    template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs, 
        typename TGet = typename Argument<arg::val::seq::At<I, IAt>, 
...
template<std::size_t I, std::size_t IAt, typename... TArgs>
Argument<arg::val::seq::At<I, IAt>, TArgs...>::Argument()
{}
...
template<typename TRet, typename TFuncMmbr, typename TDerived, 
    typename... TFuncMmbrArgs, typename TCaseId, std::size_t ICaseId, 
    typename... TVarArgs>
TRet Argument<arg::val::seq::At<I, IAt>, TArgs...>::
...
template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs, 
    typename TGet>
TGet Argument<arg::val::seq::At<I, IAt>, TArgs...>::
...
#endif //!TEST_MSG_ARG_VAL_SEQ_AT_H_