#ifndef TEST_MSG_ARG_TYPE_NAME_H_
#define TEST_MSG_ARG_TYPE_NAME_H_
...
class Argument<arg::type::Name<I>, TArgs...> :
...
template<std::size_t I, typename... TArgs>
Argument<arg::type::Name<I>, TArgs...>::Argument()
{}
...
TRet Argument<arg::type::Name<I>, TArgs...>::Call(const TCaseId&, 
    TFuncMmbr func_mmbr, TDerived& d, test::Variable<TVarArgs...>& var, 
    TFuncMmbrArgs&&... args)
{
...
#endif //!TEST_MSG_ARG_TYPE_NAME_H_