#ifndef TEST_MSG_ARG_TYPE_INDEX_H_
#define TEST_MSG_ARG_TYPE_INDEX_H_
...
template<std::size_t I, template<std::size_t, std::size_t> class TTArgArg, 
    typename... TArgs>
class Argument<arg::type::Index<I, TTArgArg>, TArgs...> :
...
public:
    ...
    using GetType = typename Argument<TTArgArg<I, IAt>>::
...
public:
    ...
    using PointerFunctionMemberType = typename Argument<TArgs...>::
        ...
        TFuncMmbrArgs..., GetForwardType<IAt, TVar>&&>;
...
public:
    template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs,
        typename TGet = typename Argument<arg::type::Index<I, TTArgArg>,
            TArgs...>::template GetType<ICaseId, test::Variable<TVarArgs...>>>
...
template<std::size_t I, template<std::size_t, std::size_t> class TTArgArg, 
    typename... TArgs>
Argument<arg::type::Index<I, TTArgArg>, TArgs...>::Argument()
{}
...
template<typename TRet, typename TFuncMmbr, typename TDerived, 
    typename... TFuncMmbrArgs, typename TCaseId, std::size_t ICaseId, 
    typename... TVarArgs>
TRet Argument<arg::type::Index<I, TTArgArg>, TArgs...>::
    Filler(const test::type::Index<TCaseId, ICaseId>& i_case_id, 
        TFuncMmbr func_mmbr, TDerived& d, test::Variable<TVarArgs...>& var, 
        TFuncMmbrArgs&&... args)
{
    return Argument<TArgs...>::template Filler<TRet>(i_case_id, func_mmbr, 
        d, var, std::forward<TFuncMmbrArgs>(args)..., 
...
template<typename TCaseId, std::size_t ICaseId, typename... TVarArgs, 
    typename TGet>
TGet Argument<arg::type::Index<I, TTArgArg>, TArgs...>::
    Get(const test::type::Index<TCaseId, ICaseId>& i_case_id, 
        test::Variable<TVarArgs...>& var)
{
    return std::move(Argument<TTArgArg<I, ICaseId>>{}.Get(i_case_id, var));
}
