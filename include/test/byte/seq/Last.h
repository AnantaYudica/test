#ifndef TEST_BYTE_SEQ_LAST_H_
#define TEST_BYTE_SEQ_LAST_H_
...
template<typename T>
inline test::byte::Sequence<test::byte::seq::Flag::last, T> Last(T&& rval)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last<%s>(rval=%p)",
...
template<typename T>
inline test::byte::Sequence<test::byte::seq::Flag::last, T> Last(T& lval)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last<%s>(lval=%p)",
...
template<typename T>
inline test::byte::Sequence<test::byte::seq::Flag::last, T>
    Last(T&& rval, const std::size_t& off)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last<%s>(rval=%p, off=%zu)",
...
template<typename T>
inline test::byte::Sequence<test::byte::seq::Flag::last, T>
    Last(T& lval, const std::size_t& off)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last<%s>(lval=%p, off=%zu)",
        TEST_SYS_DEBUG_TARGS_NAME_STR(T), &lval, off);
    
    return {std::forward<T>(lval), off};
}

inline test::byte::Sequence<test::byte::seq::Flag::last, 
    test::byte::Iterator<const std::uint8_t*>>
Last(test::byte::Iterator<const std::uint8_t*>&& begin,
    test::byte::Iterator<const std::uint8_t*>&& end)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last(begin=%p, end=%p)", &begin, &end);
    ...
    const std::size_t& off)
{
    TEST_SYS_DEBUG(test::sys::Interface, 
        TEST_SYS_DEBUG_NAMESPACE_TYPE("test::byte::seq"), 
            2, NULL, "Last(begin=%p, end=%p, off=%zu)", &begin, &end, off);
