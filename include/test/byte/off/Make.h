...
#ifndef TEST_BYTE_OFF_NAMESPACE_DLEVEL

#define TEST_BYTE_OFF_NAMESPACE_DLEVEL 2

#endif //!TEST_BYTE_OFF_NAMESPACE_DLEVEL

#ifndef TEST_BYTE_OFF_NAMESPACE_DEBUG
#define TEST_BYTE_OFF_NAMESPACE_DEBUG
TEST_SYS_DBG_NAMESPACE_LEVEL_DEFINE(TEST_BYTE_OFF_NAMESPACE_DLEVEL, "test::byte::off");
