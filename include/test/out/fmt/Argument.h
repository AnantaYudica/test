...
template<typename T, typename TFlag>
constexpr int Argument<T, TFlag>::Width()
{
    return 0;
}
...
template<typename T, typename TFlag>
template<typename... TFlagArgs>
constexpr int Argument<T, TFlag>::Width(test::out::fmt::flag::Width&& width, 
    TFlagArgs&&... flags)
{
...
template<typename TFlagArg, typename... TFlagArgs, 
    typename TFlagArg_, typename TCond_,
    typename std::enable_if<!TCond_::value, int>::type>
constexpr int Argument<T, TFlag>::Width(TFlagArg&& flag, TFlagArgs&&... flags)
{
    return Width(std::forward<TFlagArgs>(flags)...);
}

template<typename T, typename TFlag>
constexpr int Argument<T, TFlag>::Length()
{
    return 0;
}
...
template<typename T, typename TFlag>
template<typename... TFlagArgs>
constexpr int Argument<T, TFlag>::Length(test::out::fmt::flag::Length&& length,
    TFlagArgs&&... flags)
{
...
template<typename T, typename TFlag>
template<typename... TFlagArgs>
constexpr int Argument<T, TFlag>::
...
template<typename TFlagArg, typename... TFlagArgs, 
    typename TFlagArg_, typename TCond_,
    typename std::enable_if<!TCond_::value, int>::type>
constexpr int Argument<T, TFlag>::Length(TFlagArg&& flag, TFlagArgs&&... flags)
{
...
template<typename T, typename TFlag>
typename Argument<T, TFlag>:: FlagType
Argument<T, TFlag>::GetFlag() const
{
    return m_flag;
}
...
template<typename T, typename TFlag>
constexpr int Argument<T, TFlag>::GetWidth() const
{
    return m_width;
}

template<typename T, typename TFlag>
constexpr int Argument<T, TFlag>::GetLength() const
{
    return m_length;
}

template<typename T, typename TFlag>
constexpr int Argument<T, TFlag>::GetPrecision() const
{
    return m_length;
}
