...
public:
    ...
    inline Pointer(TFlagArg&& flag, TFlagArgs&&... flags);
public:
...
template<typename T>
template<typename... TFlagArgs>
inline Pointer<T*>::Pointer(T* val, TFlagArgs&&... flags) :
    test::out::fmt::Argument<T*>(FlagSpecifierType{},
...
inline Pointer<T*>::Pointer(TFlagArg&& flag, TFlagArgs&&... flags) :
    test::out::fmt::Argument<T*>(FlagSpecifierType{},
            test::out::fmt::flag::Define<T>{},
